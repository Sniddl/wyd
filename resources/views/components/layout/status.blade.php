<div class="p-3 py-2 sticky top-0 w-full bg-white border z-10 rounded">
    <div class="space-y-3 max-w-screen-sm mx-auto">
        <div class="flex sm:hidden items-center justify-between -mr-2 space-x-2">
            <x-avatar md label="AB" negative />
            <span>WYD.GG</span>
            <x-button class="!py-1 !px-2" label="Upgrade" rounded icon="check-badge" outline gray interaction="primary" />
        </div>
